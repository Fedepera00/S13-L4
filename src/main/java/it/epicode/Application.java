...
import it.epicode.eShop.Customer;
import it.epicode.eShop.Order;
import it.epicode.eShop.OrderManager;
import it.epicode.eShop.Product;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Customer cl1 = new Customer(2,"federico", 2L);
        Customer cl2 = new Customer(1,"daniele", 1L);
